...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('body', old('body',$note->body), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('status', old('status',$note->status), array('class'=>'form-control')) !!}
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      ...
      {!! link_to_route(config('quickadmin.route').'.note.index', trans('quickadmin::templates.templates-view_edit-cancel'), null, array('class' => 'btn btn-default')) !!}
    </div>
</div>
